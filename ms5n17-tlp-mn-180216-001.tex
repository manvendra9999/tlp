...
The spectra in \fig{fig:lineshape} and \fig{fig:media-spec} were obtained with water presaturation followed by a 90$^{\circ}$ pulse. Spectrum in figure~\ref{fig:15N-nutation} was acquired using pulse sequence described in~\cite{bax_indirect}.
...
$^{15}$N frequency was therefore detected indirectly using coherence transfer to protons. 
