...
The semi-rigid cables (RG 402) are  threaded through these hollow aluminium tubes
...
low-loss SMP connectors (14 in \fig{fig:ProbePhoto}). \cbstart SMP Connector Receptacle Male Pin is soldered on the TMPCB and SMP Connector Jack Male Pin is soldered on the PCB plane 3. The TMPCB and 3 are connected by a coaxial connector SMP plug adapter.\cbend
...
\hline
Material   & $\frac{\chi/PPM}{\rho/(g cm^{-3})}$	\\
\hline
PMMA		&-7.609(5)	\\
Copper	&-9.63	\\
FR4	&-1.918(9)		\\
...
\begin{table}[h]
\centering
\caption{Details of the circuit elements}
\label{tab:circut}
\begin{tabular}{||p{.3\linewidth}|p{.3\linewidth}|p{.3\linewidth}||}
\hline
Circuit element   & Value	&Part Number\\
\hline
$C_1$, $C_2$ and, $C_8$		&1-23 pf	& NMAM25HV\\
$C_9$	&3-23 pf	& NMNT23-6\\
$C_3$, $C_7$	&4.3 pf		& S111TUE\\
$C_4$	&82 pf	& S111TUE\\
$C_5$, $C^{'}_{5}$	&2.4	& S111TUE\\
...
\begin{figure}
\centering
\includegraphics[width=.96\linewidth,keepaspectratio=true]{./figures/ms5n17-tlp-im-180110-circuit-diagram.png}
...
short bits of 0.5~mm \cbstart diameter copper wire, \cbend which were soldered to the appropriate pads in
...
\cbstart
\fig{fig:field map} were created through having echo times ($t_{e}$) of 6 and 16 ms and repetition time ($t_{r}$) of 100 ms. \fig{fig:1H-nutation} of the water peak in an aqueous solution of 100~mM $^{15}$N-urea. \fig{fig:lineshape} shows proton spectrum of 2.5 $\mu$l of 130 mM  sodium acetate dissolved in H$_2$O acquired at 600 MHz. The spectrum was acquired with water presaturation at 100~Hz. 32 transients were averaged with a repetition delay of 3~s. The proton spectrum of DMEM (Dulbecco
modified Eagle's medium) cell growth medium acquired with 256 scans in 20 mins
is shown in \fig{fig:media-spec}.
The left panel shows a $^{13}$C-$^{1}$H heteronuclear single
...
The image shown in \fig{fig:tisli}(B) was acquired using a FLASH pulse sequence with $t_R=120$~ms
and $t_E=15.3$~ms. The slice thickness of  1~mm encompasses the entire thickness
of the tissue \fig{fig:tisli}(C) shows a
...
810$^{\circ}$/90$^{\circ}$ ratio of more than 90\% measured from $^1$H nutation at 600~MHz~\fig{fig:1H-nutation}. The
...
\fig{fig:lineshape} shows the spectrum of sodium acetate. The inset shows an expanded view of the base of the acetate peak. Carbon satellites can be seen well above the noise level. The orange curve
