...
available for download at \cite{github-probe-download-2019}.
...
\label{fig:tandm} \end{figure} Initially, FR4 PCB material was used for the
...
detectors were made from RO3035 material. While RO3035 provides better
...
\begin{figure} \centering
\includegraphics[width=.9\linewidth,keepaspectratio=true]{./figures/pcb-fieldmap-colorbar.png}
...
with echo times $t_E=5.3$~ms and 15.3~ms, respectively. , corresponding to local
field variations of $\Delta B/B_0=...$ \todo{compute value and insert here}.
